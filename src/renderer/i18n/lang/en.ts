export const en = {
  ...
  "memory.importance.desc.1": "Searchable only, never injected",
  "memory.importance.desc.2": "Default; searchable only",
  "memory.importance.desc.3": "Auto-injected into new sessions",
  "memory.importance.desc.4": "Auto-injected, for key knowledge",
  "memory.importance.desc.5": "Auto-injected, must-know only",
