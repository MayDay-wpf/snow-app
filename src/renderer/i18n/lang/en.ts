export const en = {
  ...
  "settings.attachContextInfo":
    "Drag a past conversation into the input box to inject it as prefix context for the current conversation. Before injection the content is automatically cleaned (thinking chains and tool-execution details removed) and trimmed to budget to protect the context window.",
  "settings.attachContextSingleBudget": "Per-attachment budget (chars)",
  "settings.attachContextTotalBudget": "Total budget for all attachments (chars)",
  "settings.attachContextReset": "Reset to defaults",
  "settings.attachContextSaved": "Saved",
  "settings.attachContextBudgetHint": "Range 1000-200000; values outside are clamped.",
  ...
  "conversationContext.pendingAttach": "Will be attached as prefix context after sending",
