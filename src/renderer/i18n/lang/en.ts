export const en = {
  ...
  "settings.imageLibraryEmpty":
    "No images yet. Generated images appear here automatically.",
  "settings.imageLibraryDragImportHint":
    "You can also drag local images into this page to import them.",
  ...
  "settings.imageLibraryBatchCopyPrompt": "Copy prompts",
  "settings.imageLibrarySentToChat": "Sent to chat input",
  "settings.imageLibraryRefSet": "Set as reference image",
  ...
  "rightPanel.tabContextNewDrawing": "New Drawing",
  "rightPanel.aiDrawing.promptPlaceholder": "Describe the image you want to create, Chinese supported; e.g. a cyberpunk rainy city at night with neon reflections…",
  ...
  "rightPanel.aiDrawing.modelHint": "Models are aggregated from the model APIs of configured channels; picking a model auto-selects its provider",
  "rightPanel.aiDrawing.modelsLoading": "Loading models…",
  "rightPanel.aiDrawing.modelsLoadFailed": "Failed to load models",
  "rightPanel.aiDrawing.ratio": "Aspect ratio",
  "rightPanel.aiDrawing.tier": "Tier",
  "rightPanel.aiDrawing.resolution": "Resolution",
  "rightPanel.aiDrawing.sizeDefault": "Channel default",
  "rightPanel.aiDrawing.advanced": "Advanced",
  ...
  "rightPanel.aiDrawing.compression10": "10 (small size)",
  "rightPanel.aiDrawing.compression50": "50 (balanced)",
  "rightPanel.aiDrawing.compression90": "90 (high quality)",
  ...
  "rightPanel.aiDrawing.personGeneration": "Persons",
  ...
  "rightPanel.aiDrawing.personAllowAdult": "Allow adult",
  "rightPanel.aiDrawing.webSearch": "Web search",
  "rightPanel.aiDrawing.imageSearch": "Image search",
  "rightPanel.aiDrawing.seed": "Seed",
  "rightPanel.aiDrawing.seedPlaceholder": "Empty = random",
  "rightPanel.aiDrawing.seedHint": "Same seed reproduces similar results",
  "rightPanel.aiDrawing.count": "Count",
  "rightPanel.aiDrawing.stream": "Streaming preview",
  ...
  "rightPanel.aiDrawing.noChannel": "No usable image channel configured",
  "rightPanel.aiDrawing.reference": "Reference image",
  ...
  "rightPanel.aiDrawing.history": "Library history",
  "rightPanel.aiDrawing.historyEmpty": "No records yet; generated images are stored to the library automatically",
  ...
  "rightPanel.aiDrawing.deleteDialogBody": "Delete this image? The file will be removed from the library and cannot be restored.",
  ...
  "rightPanel.aiDrawing.refresh": "Refresh library",
  "rightPanel.aiDrawing.modelReset": "Reset to channel default model",
  "rightPanel.aiDrawing.modelOverridden": "Overridden",
  "rightPanel.aiDrawing.modelSingleCount": "This model always generates a single image",
  ...
  "rightPanel.aiDrawing.modelUnsupportedRef": "This model does not support image editing; the reference image will be ignored",
  "rightPanel.aiDrawing.uploadImage": "Upload reference",
  "rightPanel.aiDrawing.uploadHint": "Upload a local image as the reference image (image-to-image); it will NOT be added to the library",
  "rightPanel.aiDrawing.uploadDialogTitle": "Select reference image",
  "rightPanel.aiDrawing.uploadRefDone": "Set as reference image",
  "rightPanel.aiDrawing.refSetDone": "Set as reference image",
  "rightPanel.aiDrawing.libraryDragHint": "Drag: images to the chat box to send, to the canvas to use as reference; drop local images here to import",
  "rightPanel.aiDrawing.importDone": "Imported {{count}} image(s) to the library",
  "rightPanel.aiDrawing.importFailed": "Image import failed",
  "rightPanel.aiDrawing.retry": "Retry",
  "rightPanel.aiDrawing.openSettings": "Open image generation settings",
  "rightPanel.aiDrawing.emptyHintSub": "Type your idea and let AI turn it into an image",
  "rightPanel.aiDrawing.generatingDetail": "Generating images, please wait…",
  "rightPanel.aiDrawing.resultCount": "{{count}} image(s) generated",
  "rightPanel.aiDrawing.lightboxCounter": "{{index}} / {{total}}",
  "rightPanel.aiDrawing.errorHint.timeout": "Generation took too long. Try again later, or disable streaming preview and retry.",
  "rightPanel.aiDrawing.errorHint.auth": "Invalid API key or no permission. Check the channel configuration and quota in Settings → Image generation.",
  "rightPanel.aiDrawing.errorHint.rateLimit": "Rate limited or quota exhausted. Wait a moment and try again, or check your account quota.",
  "rightPanel.aiDrawing.errorHint.contentFiltered": "The prompt or reference image triggered the provider's safety filter. Adjust the content and retry.",
  "rightPanel.aiDrawing.errorHint.server": "Provider service is temporarily unavailable. Retry later or switch to another channel.",
  "rightPanel.aiDrawing.errorHint.network": "Network connection failed. Check your network/proxy settings and retry.",
  "rightPanel.aiDrawing.errorHint.noModel": "No usable image channel configured. Configure a channel and model in Settings → Image generation first.",
  "rightPanel.aiDrawing.errorHint.modelNotFound": "Model not found or unavailable. Check the model name, or switch models in Settings → Image generation.",
  "rightPanel.aiDrawing.errorHint.modelUnsupported": "This model does not support the requested operation (e.g. image-to-image / transparent background). Switch models or adjust parameters.",
  "rightPanel.aiDrawing.errorHint.missingPrompt": "The request is missing a prompt. Fill in a prompt and retry.",
  "rightPanel.aiDrawing.errorHint.sizeInvalid": "Size / aspect ratio not supported by this model. Adjust Aspect ratio / Tier and retry.",
  "rightPanel.aiDrawing.errorHint.invalidParams": "Invalid request parameters. Check the advanced parameters (format / compression / background, etc.) and retry.",
  ...
  "rightPanel.aiDrawing.errorHint.fallback": "Generation failed. Adjust the prompt or parameters and retry; see the error details below if it keeps failing.",
  "rightPanel.aiDrawing.cancel": "Cancel",
  "rightPanel.aiDrawing.cancelHint": "Abandon the wait and discard this result (the background request will still complete, but its result is ignored)",
  "rightPanel.aiDrawing.streamOffCount": "Streaming preview is unavailable when count > 1",
  "rightPanel.aiDrawing.streamOffRef": "Streaming preview is unavailable for image-to-image",
  "rightPanel.aiDrawing.retryModels": "Retry loading models",
  "rightPanel.aiDrawing.examplesTitle": "Try these",
  "rightPanel.aiDrawing.example1": "A rainy cyberpunk city at night, neon reflections, cinematic composition",
  "rightPanel.aiDrawing.example2": "An orange cat sitting by the window, morning light, watercolor style, soft tones",
  "rightPanel.aiDrawing.example3": "A floating island above the clouds, waterfall pouring down, fantasy illustration",
  "rightPanel.aiDrawing.example4": "A vintage film-grain portrait, warm tones, shallow depth of field, blurred background",
  "rightPanel.aiDrawing.collapse": "Collapse library history",
  "rightPanel.aiDrawing.expand": "Expand library history",
  "rightPanel.aiDrawing.duration": "Done in {{seconds}}s",
  "rightPanel.aiDrawing.refLimit": "Up to 5 reference images; extras were ignored",
  "rightPanel.aiDrawing.refAdded": "Reference image added",
  "rightPanel.aiDrawing.refSkippedDuplicate": "Reference image already added, skipped",
